...
<div class="login-form">
   ...
   <a href="./join">회원가입</a>
      ...
      <div class="sign_movement">
            <p>
               회원가입 후 <span>가치공간 서비스를 이용</span>해보세요!
            </p>
      ...
      <section id="layerPopup" class="layer-wrap find_pw_w">
        <div class="find_pw">
         <div class="btnClose pa_13_im">닫기버튼</div>
         <div class="text_find_pw">
            <h4>FIND PASSWORD</h4>
            <span>가입하신 정보를 입력해주시면 등록된 휴대폰 번호로 전송 해드립니다.</span>
         </div>          
         
         <form autocomplete="off" action="/member/_handle" id="find_form" method="post" onsubmit="return find_form_check();" target="_hidden_frame">
            <input type="hidden" name="act" value="send_password">
            <div class="pw_find_input_w">
               <div class="fi_pw_w">
                  <h3><label for="find_user_name">이름</label></h3>
                  <input type="text" name="find_user_name" id="find_user_name" class="fi_pw_bo input_border required" placeholder="가입한 이름을 입력해주세요." />
                  <span id="find_user_name_text" style="display:none" class="warningTxt2">이름을 입력해주세요.</span>
               </div>
               <div class="fi_pw_w">
                  <h3><label for="find_user_email">이메일</label></h3>
                  <input type="text" name="find_user_email" id="find_user_email" class="fi_pw_bo input_border required" placeholder="가입시 입력한 이메일을 입력해주세요." />
                  <span id="find_user_email_text" style="display:none" class="warningTxt2">이메일 주소를 정확히 입력해주세요.</span>
               </div>
            </div>
            <div class="btn_new_style">
               <button type="button" class="btn-cancel btn_new btn_clear_black">취소</button>
               <button type="submit" class="btn_new btn_pinkred" id="find_submit">발송하기</button>
            </div>
          </form>
        </div>
      </section>
...
document.addEventListener('DOMContentLoaded', function () { // document ready
   ...
   $(function(){
      $("#container").simpleCalendar({
         ...
         initialDate: new Date('2023-11-06'),
         ...
         onInit: function(calendar){
            ...
            document.querySelectorAll('div.day').forEach(function(day){
               if(parseInt(day.textContent) < parseInt('06'))
               {
         ...
         onDateSelect: function (date, events){
            var current_date = new Date('2023-11-06')
