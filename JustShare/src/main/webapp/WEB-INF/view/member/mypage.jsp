...
<html lang="en">
  <head>
	...
	<link rel="canonical"  href="https://www.valuevenue.co.kr/member/mypage"/>
	...
	<meta property="og:url"			 content="https://www.valuevenue.co.kr/member/mypage" />
...
<script>
var _ss_user_id	= "515a65b9da51420ab0583ee4807c7c1f";
</script>
  </head>
<body>
  <div class="body__container section">
  <input type="hidden" class="is_phpself" value="/member/mypage.php">
...
<!--                  <div class="grade grade1">공간 호스트</div>-->

<!--                  <div class="grade grade1">브랜드셀러</div>-->
	...
	swiper_init("event_card1", 16, 25);
      ...
      <div class="mypage-lay1-gridC2" id="brand_guide_div" style='display:none'>
       ...
       <div class="card__item4 swiper-slide">			  
          ...
          <!-- <button class="btn btn--outlined-primary">브랜드 가이드 보기</button>
          <button type="button" class="btn btn--primary" onclick="top.location.href='/brand/register';">브랜드 등록</button>
          <button class="btn btn--outlined-red" style="" onclick="disabled_brand();">7일동안 보이지 않기</button> -->
        </div>
      </div>
      <!-- 브랜드 등록 2 COL - E N D -->
      <!-- 공간 등록 2 COL - START -->
