...
public class ExampleController {
    ...
    public ExampleController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSSD9CDRYHDBQ1Y", "NENQDBPJYPWBLNNYJA4BD9N0O2MG5OOB", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setFrom("01087514538");
        message.setTo("01087514538");
